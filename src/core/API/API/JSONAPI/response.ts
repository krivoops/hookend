...
const performFormat = (Model, fields, models, included, isIncluded, req) => {
    ...
    Object.keys(fields).forEach((key) => {
        ...
        } else if (Model.modelSchema[key] && Model.modelSchema[key].ref && models[Model.modelSchema[key].ref].includeBehavior && !(fields[key] instanceof ObjectID)) {
